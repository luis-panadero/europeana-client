 ...
 * @version 1.0
 * 
 *          EuropeanaApi2Client class accesses the Search API V2 by setting up a
 *          connection via search URI and API key (see also config file).
...
public class EuropeanaApi2Client extends BaseApiConnection {
     ...
     * key.
     * 
     * @param europeanaSearchUri:
     *            Search URI for the Europeana search request (see config file).
     * @param apiKey:
     *            API key for the Europeana search request (see config file).
     */
     ...
     * 
     * This method takes a query interface object and the limit and start of a
     * query to generate a URL and use it to get search results from the search
     ...
     * @return The return value is a EuropeanaApi2Results object containing the
     *         search results.
     * @throws IOException
     ...
     * 
     * The method retrieves a json result from the provided URL and generates a
     * EuropeanaApi2Results object based on the json data.
     * 
     * @param url:
     ...
     * @throws EuropeanaApiProblem
     */
    protected EuropeanaApi2Results getSearchResults(String url) throws IOException, EuropeanaApiProblem {
    ...
    public EuropeanaApi2Results parseApiResponse(String jsonResult) throws EuropeanaApiProblem {
     ...
     * Method for remote invocation of Europeana Search API, Version 2
     * 
     * This method takes a portal search url string and the limit and start of a
     * query to generate a query interface object and URL and use them to get
     * search results from the search API by calling the
     * {@link #getSearchResults(String)} method.
     * 
     * @param portalSearchUrl:
     *            search URL for the portal search.
     * @param limit:
     *            the limit for the amount of results retrieved.
     * @param start:
     *            the starting index for the query results.
     ...
     * @throws EuropeanaApiProblem
     */
    public EuropeanaApi2Results searchApi2(String portalSearchUrl, int limit, int start)
            throws IOException, EuropeanaApiProblem {
     ...
     * 
     * The method uses the client configuration to generate a url and retrieve
     * json results. The json results are used to generate a full
